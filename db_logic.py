...
-------------------------------------------
Stores student records (personal details, academic performance) and daily
attendance in a SQLite database, using plain parameterised SQL queries, with
validation for accurate data entry and retrieval.

The Flask routes that call these functions live in __init__.py.
"""
import random
import sqlite3
